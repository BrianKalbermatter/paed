...
module.exports = grammar({
  ...
  rules: {
    ...
    // pueda pintar distinto "la declaro" de "la uso", si algun dia se quiere.
    declaracion_subaccion: ($) =>
      seq(
    ...
    //
    // El `token.immediate` es lo que hace que funcione: exige que el '(' venga
    // SIN espacio en el medio. Sin eso, `contador (a + b)` tambien seria una
    // llamada, y no lo es.
    //
    // OJO CON EL ALCANCE: esto pinta CUALQUIER nombre seguido de parentesis.
    // Una funcion que escribiste vos, si; pero tambien CUBO o BILLBOARD de una
